...
# Software tools (Update the links/versions before publish)
...
* [MPLAB®  Code Configurator Library (CCL) v1.37.7](https://www.microchip.com/mplab/mplab-code-configurator)
...
* RB7 Used for RX2 and RA4 for T0CKI can be deselected.
...
* Click the Generate button next to the project Resources heading to generate Initializers and derivers for configured peripherals. Next step is to add custom code to complete the example as following.
